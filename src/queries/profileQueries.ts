...
export const profileQueryKeys = {
  ...
  preferredOpposition: (userId: string, locale: string) =>
    ["profiles", "preferred-opposition", userId, normalizeLocale(locale)] as const,
  resolvedOpposition: (
...
const fetchProfileBase = async (userId: string): Promise<ProfileBaseRow | null> => {
...
export const useProfileBaseQuery = (userId: string | null | undefined) =>
  useQuery({
    queryKey: userId ? profileQueryKeys.base(userId) : ["profiles", "base", "guest"],
